...
import { FichaClienteComponent } from 'app/entities/ficha-cliente/ficha-cliente.component';
...
describe('Component Tests', () => {
  describe('FichaCliente Management Component', () => {
    let comp: FichaClienteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FichaClienteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fichaClientes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
